#!/bin/zsh
# Generated by Powerlevel10k configuration wizard on 2022-08-26 at 18:53 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_FOREGROUND=15
  typeset -g POWERLEVEL9K_ASDF_RUST_BACKGROUND=202
  ...
  typeset -g POWERLEVEL9K_ASDF_JAVA_FOREGROUND=7
  typeset -g POWERLEVEL9K_ASDF_JAVA_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=202
