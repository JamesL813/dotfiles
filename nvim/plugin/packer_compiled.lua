...
_G.packer_plugins = {
  edge = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/edge",
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
